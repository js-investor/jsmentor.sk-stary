        ...
        <div className="calc-page">
          <header className="calc-header calc-reveal" style={reveal(0)}>
            ...
            <p className="calc-subtitle">
              Zadaj vklady, dobu a&nbsp;výnos. Pridaj udalosti v&nbsp;čase, napríklad vyšší vklad od piateho roka alebo jednorazový
              vklad, a&nbsp;uvidíš hodnotu portfólia, čo z&nbsp;nej ukroja poplatky a&nbsp;daň a&nbsp;koľko ti ostane po inflácii.
            </p>
          </header>
          ...
          <section className="calc-dock calc-reveal" aria-label="Parametre investície" style={reveal(1)}>
            ...
            <div className="calc-dock-foot">
              ...
              <div id="inv-events-content" className="pb-4 pt-1">
                ...
                <div id="inv-events-list" className="inv-events-list" />
                <button type="button" id="inv-add-event" className="inv-add-event">+ Pridať udalosť</button>
              </div>
          ...
          <section className="calc-hero-xl calc-reveal" aria-label="Výsledok" style={reveal(2)}>
            ...
            <div className="calc-hero-xl-chips">
              ...
              <span className="calc-verdict-chip inv-chip-events" id="inv-events-chip" style={{ display: "none" }}>
                Udalosti&nbsp;<strong id="inv-eventsDeltaVal">0 €</strong>&nbsp;k výsledku pri vkladoch&nbsp;<strong id="inv-eventsInvestedVal">0 €</strong>
              </span>
            </div>
          </section>
          ...
          <section className="calc-panel calc-reveal mt-5 md:mt-6" aria-label="Vývoj v čase" style={reveal(5)}>
            <div className="calc-chart-head">
              ...
              <div className="calc-legend">
                ...
                <span className="calc-legend-item" id="inv-legend-events" style={{ display: "none" }}>
                  <span className="calc-legend-dot inv-legend-event" aria-hidden />
                  Udalosť
                </span>
              </div>
            </div>
          ...
          <p className="calc-note calc-note--center mt-5 md:mt-6">
            Kalkulačka je orientačná — počíta s konštantným ročným výnosom. Udalosti platia od začiatku zvoleného roka a počítajú sa
            aj s poplatkami. Poplatky a daň zohľadňuje podľa hodnôt v sekcii „Inflácia, poplatky a daň“; graf zobrazuje hodnotu pred zdanením.
          </p>
        </div>
      </div>
    </div>
